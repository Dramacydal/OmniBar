...
ShowCooldownCount:SetPoint("TOPLEFT", Visible, "BOTTOMLEFT", 0, -2)
...
ColumnsSlider = CreateSlider("Columns", OptionsPanel, 1, OmniBar.MAX_ICONS+1, 1)
...
OptionsPanel.refresh = function()
	...
	ColumnsSlider:SetValue(OmniBar.settings.columns and OmniBar.settings.columns < 0 and OmniBar.settings.columns or OmniBar.MAX_ICONS + 1)
